...
namespace _2017_4_3
{
    ...
    public class BinarySearchTree //实现画树接口
    {    //成员变量
        ...
        {   //如果是空树，则新结点成为二叉排序树的根
            ...
            while (current != null)
            {
                ...
                current = (value < current.Data) ? prev.Left : prev.Right;
            }
        ...
        private void RemoveNode(Node node)
        {
            ...
            {   //首先找到惟一的孩子结点
                ...
                else  //当删除的是根结点时，当然，此时只有tmp一个子节点
                {
                    _head = tmp;
                }
            }
